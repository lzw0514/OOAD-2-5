...
public class DivRefundTransPoSqlProvider {
    ...
    public String insertSelective(DivRefundTransPo row) {
        ...
        if (row.getLedgerId() != null) {
            sql.VALUES("`ledger_id`", "#{ledgerId,jdbcType=BIGINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (row.getAccountId() != null) {
            sql.SET("`account_id` = #{row.accountId,jdbcType=BIGINT}");
        }
        ...
        if (row.getLedgerId() != null) {
            sql.SET("`ledger_id` = #{row.ledgerId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(DivRefundTransPo row) {
        ...
        if (row.getLedgerId() != null) {
            sql.SET("`ledger_id` = #{ledgerId,jdbcType=BIGINT}");
        }
