...
public interface DivPayTransPoMapper {
    ...
    @Insert({
        ...
        "#{accountId,jdbcType=BIGINT}, #{status,jdbcType=TINYINT}, ",
        "#{shopId,jdbcType=BIGINT}, #{ledgerId,jdbcType=BIGINT})"
    })
    ...
    @Select({
        ...
        "`modifier_name`, `gmt_create`, `gmt_modified`, `account_id`, `status`, `shop_id`, ",
        "`ledger_id`",
