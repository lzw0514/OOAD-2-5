...
public class ProductService {
     ...
     * @return 操作结果
     */
    public ReturnObject saveOrUpdateProduct(ProductEs productEs) {
        ...
        return new ReturnObject(ReturnNo.OK,
                String.format("Product saved or updated successfully: id=%d, name='%s'",
                        productEs.getId(), productEs.getName()));
    }
     ...
     * @return 查询结果
     */
    public ReturnObject searchProducts(String name, String barcode, Long shopId, int page, int size) {
        ...
        if (esPage.isEmpty()) {
            ...
            return new ReturnObject(ReturnNo.OK, List.of());
        }
