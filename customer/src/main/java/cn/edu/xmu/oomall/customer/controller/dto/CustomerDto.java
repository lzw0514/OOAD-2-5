...
public class CustomerDto {
    ...
    public void setUserName(@NotBlank(message = "用户名不能为空", groups = {NewGroup.class}) String userName) {
    ...
    public void setPassword(@NotBlank(message = "密码不能为空", groups = {NewGroup.class}) String password) {
    ...
    public void setMobile(@NotBlank(message = "邮箱不能为空", groups = {NewGroup.class}) String mobile) {
        this.mobile = mobile;
    }
