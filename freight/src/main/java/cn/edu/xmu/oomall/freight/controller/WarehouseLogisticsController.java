...
public class WarehouseLogisticsController {
    ...
    public ReturnObject addWarehouseLogistics(@PathVariable Long shopId,
                                         ...
                                         @RequestBody WarehouseLogisticsDto vo,
    ...
    public ReturnObject getWarehouseLogistics(@PathVariable Long shopId,
        ...
        List<cn.edu.xmu.oomall.freight.controller.vo.WarehouseLogisticsDto> warehouseLogisticsDtoList = warehouseLogistics.stream()
                .map(warehouseLogistic -> CloneFactory.copy(new cn.edu.xmu.oomall.freight.controller.vo.WarehouseLogisticsDto(warehouseLogistic), warehouseLogistic)).collect(java.util.stream.Collectors.toList());
        return new ReturnObject(new PageVo<>(warehouseLogisticsDtoList, page, pageSize));
    }
