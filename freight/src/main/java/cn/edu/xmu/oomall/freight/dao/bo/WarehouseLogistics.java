...
@CopyFrom({WarehouseLogisticsDto.class, WarehouseLogisticsPo.class})
public class WarehouseLogistics extends OOMallObject implements Serializable {
    ...
    public void buildShopLogistics(Long shopId) throws RuntimeException {
        ...
        this.account = this.accountDao.findById(shopId, this.shopLogisticsId);
        this.accountDao.build(this.account);
        this.account.buildLogistics();
    }
